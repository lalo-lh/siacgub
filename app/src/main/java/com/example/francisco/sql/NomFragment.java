...
public class NomFragment extends Fragment {
    ...
    private NomFragment.MyAppAdapter myAppAdapter; //Array Adapter
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nom, container, false);
    }
    ...
    public void onActivityCreated(Bundle state) {
        ...
        NomFragment.SyncData orderData = new NomFragment.SyncData();
        orderData.execute("");
    }
    ...
    public void onResume(){
        super.onResume();
        ((Main2Activity) getActivity()).setActionBarTitle("NOMINAS");
    }
    ...
    private class SyncData extends AsyncTask<String, String, String>
    {
        ...
        protected void onPostExecute(String msg) // disimissing progress dialoge, showing error and setting up my listview
        {
            ...
            if (success == false)
            {
                ...
                try {
                    myAppAdapter = new NomFragment.MyAppAdapter(itemArrayList, getActivity());
    ...
    public class MyAppAdapter extends BaseAdapter         //has a class viewholder which holds
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) // inflating the layout and initializing widgets
        {
            ...
            NomFragment.MyAppAdapter.ViewHolder viewHolder= null;
            if (rowView == null)
            {
                LayoutInflater inflater = getLayoutInflater();
                rowView = inflater.inflate(R.layout.table_element, parent, false);
                viewHolder = new NomFragment.MyAppAdapter.ViewHolder();
                viewHolder.nombre = (TextView) rowView.findViewById(R.id.txt1);
                viewHolder.domicilio = (TextView) rowView.findViewById(R.id.txt2);
                viewHolder.telefono = (TextView) rowView.findViewById(R.id.txt3);
                viewHolder.grado = (TextView) rowView.findViewById(R.id.txt4);
                rowView.setTag(viewHolder);
            }
            else
            {
                viewHolder = (NomFragment.MyAppAdapter.ViewHolder) convertView.getTag();
            }
