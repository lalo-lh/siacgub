...
public class IngFragment extends Fragment {
    ...
    private IngFragment.MyAppAdapter myAppAdapter; //Array Adapter
    ...
    public void onActivityCreated(Bundle state) {
        ...
        listView = (ListView) getView().findViewById(R.id.listing);
        itemArrayList = new ArrayList<Estudiante>(); // Arraylist Initialization
        IngFragment.SyncData orderData = new IngFragment.SyncData();
        orderData.execute("");
    }
    ...
    public void onResume(){
        super.onResume();
        ((Main2Activity) getActivity()).setActionBarTitle("INGRESOS");
    }
    ...
    private class SyncData extends AsyncTask<String, String, String>
    {
        ...
        protected void onPostExecute(String msg) // disimissing progress dialoge, showing error and setting up my listview
        {
            ...
            if (success == false)
            {
                ...
                try {
                    myAppAdapter = new IngFragment.MyAppAdapter(itemArrayList, getActivity());
    ...
    public class MyAppAdapter extends BaseAdapter         //has a class viewholder which holds
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) // inflating the layout and initializing widgets
        {
            ...
            IngFragment.MyAppAdapter.ViewHolder viewHolder= null;
            if (rowView == null)
            {
                LayoutInflater inflater = getLayoutInflater();
                rowView = inflater.inflate(R.layout.table_ingre, parent, false);
                viewHolder = new IngFragment.MyAppAdapter.ViewHolder();
                viewHolder.nombre = (TextView) rowView.findViewById(R.id.txting0);
                viewHolder.domicilio = (TextView) rowView.findViewById(R.id.txting1);
                viewHolder.telefono = (TextView) rowView.findViewById(R.id.txting2);
                //viewHolder.grado = (TextView) rowView.findViewById(R.id.txt4);
                rowView.setTag(viewHolder);
            }
            else
            {
                viewHolder = (IngFragment.MyAppAdapter.ViewHolder) convertView.getTag();
            }
