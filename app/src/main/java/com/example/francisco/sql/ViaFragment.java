...
public class ViaFragment extends Fragment {
    ...
    private ViaFragment.MyAppAdapter myAppAdapter; //Array Adapter
    ...
    public void onActivityCreated(Bundle state) {
        ...
        listView = (ListView) getView().findViewById(R.id.listvia);
        itemArrayList = new ArrayList<Estudiante>(); // Arraylist Initialization
        ViaFragment.SyncData orderData = new ViaFragment.SyncData();
        orderData.execute("");
    }
    ...
    public void onResume(){
        super.onResume();
        ((Main2Activity) getActivity()).setActionBarTitle("VIATICOS");
    }
    ...
    private class SyncData extends AsyncTask<String, String, String>
    {
        ...
        protected void onPostExecute(String msg) // disimissing progress dialoge, showing error and setting up my listview
        {
            ...
            if (success == false)
            {
                ...
                try {
                    myAppAdapter = new ViaFragment.MyAppAdapter(itemArrayList, getActivity());
    ...
    public class MyAppAdapter extends BaseAdapter         //has a class viewholder which holds
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) // inflating the layout and initializing widgets
        {
            ...
            ViaFragment.MyAppAdapter.ViewHolder viewHolder= null;
            if (rowView == null)
            {
                LayoutInflater inflater = getLayoutInflater();
                rowView = inflater.inflate(R.layout.table_via, parent, false);
                viewHolder = new ViaFragment.MyAppAdapter.ViewHolder();
                viewHolder.nombre = (TextView) rowView.findViewById(R.id.txtvia0);
                viewHolder.domicilio = (TextView) rowView.findViewById(R.id.txtvia1);
                viewHolder.telefono = (TextView) rowView.findViewById(R.id.txtvia2);
                viewHolder.grado = (TextView) rowView.findViewById(R.id.txtvia3);
                rowView.setTag(viewHolder);
            }
            else
            {
                viewHolder = (ViaFragment.MyAppAdapter.ViewHolder) convertView.getTag();
            }
